...
function Home(props) {
    ...
    useEffect(() => {
        ...
        bg.onload = () => {
            setIsReady(true);
            piano = document.getElementById("pcp-piano-jpg");
        ...
        document.addEventListener('scroll', (e) => {
            ...
            } else if (posScroll < 300) {
                piano.style.opacity = 1 - (posScroll * 3 / 1000);
                blackBg.style.opacity = 1 - (posScroll * 3 / 1000);
                sub.style.color = `rgb(${255 - (posScroll * 3 / 3.6)}, ${255 - (posScroll * 3 / 3.6)}, ${255 - (posScroll * 3 / 3.6)})`;
            } else {
    ...
    return isReady ? (
        <div className="home-main-wrapper">
            <button id="pcp-language" onClick={props.toggleLanguage}><img src={props.language === "fr" ? "./union jack.png" : "./french flag.png"} height="12px" /></button>
