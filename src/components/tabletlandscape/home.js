        ...
        <div className="home-main-wrapper">
            ...
            <animate attributeName="r" values="1000;1150;" dur="0.5s" repeatCount="1" fill="freeze"/>
                ...
                <div className="pcl-main">
                    ...
                    <p style={{fontSize: "calc(1vh + 1vw)"}} className="pcl-main-text">{language === "fr" ? "Pierre ANGOT est un compositeur français né en Normandie , le premier mars 1958." : "Pierre ANGOT is a French composer born in Normandy on March 1, 1958."}</p>
                ...
                >
                    <p style={{fontSize: "calc(0.75vh + 1vw)"}} id="pcl-footer-text">Designed by <a id="pcl-footer-link" href="http://www.cyrilmorin.fr" rel="noreferrer" target="_blank">Cyril Morin</a>, contact: <a href="mailto:cyril.morin.tai@gmail.com" rel="noreferrer">cyril.morin.tai@gmail.com</a></p>
                </div>
            </div>
        </div>
    ) : null;
