...
function Home(props) {
    ...
    return isReady ? (
        <div className="home-main-wrapper">
            <button id="language" onClick={props.toggleLanguage}><img width="24px" src={props.language === "fr" ? "./union jack.png" : "./french flag.png"} /></button>
            ...
            <div className="pcl-content-wrapper">
                ...
                <div id="pcl-background-container" className="pcl-background-container">
                    <img src={concert} id="pcl-piano-jpg" height="600px" />
                    <div id="black-bg"></div>
                ...
                >
                    <CSSTransition
                        ...
                        appear={true}
                    >
                        <h1 id="pcl-main-title"
                            style={{
                                fontSize: "calc(2vh + 2vw)",
                                paddingTop: 0,
                                marginBottom: "5vh"
                            }}
                        >{language === "fr" ? "Pierre Angot, Compositeur Français" : "Pierre Angot, French Composer"}</h1>
                    </CSSTransition>
                    <CSSTransition
                        in={true}
                        classNames="nav"
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="pcl-nav-list-container"><li><Link style={{ fontSize: "calc(0.75vh + 1.5vw)" }} className="pcl-nav-list" to="/about">{language === "fr" ? "Tarifs, catalogue, licence et contact" : "Tariffs, catalog, license and contact"}</Link></li></div>
                        </ul>
                    </CSSTransition>
                </div>
