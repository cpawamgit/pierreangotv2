...
function Home(props) {
    ...
    useEffect(() => {
        ...
        document.addEventListener('scroll', (e) => {
            ...
            } else if (posScroll < 225) {
                piano.style.opacity = 1 - (posScroll * 4 / 1000);
                blackBg.style.opacity = 1 - (posScroll * 4 / 1000);
